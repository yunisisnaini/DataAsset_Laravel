    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><b>DATA ASSET GEDUNG DAN BANGUNAN</b></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="table-action-container">
                    <a class="btn btn-info" href="bangunan/create"><i class="fa fa-plus-circle"></i>Tambah Data</a>
                ...
                <div class="table-responsive" style="margin-top: 20px;">
                    <table id="myTable" class="table table-bordered table-striped text-center">
                        <thead>
                            ...
                            <style>
                                /* Atur warna latar belakang tabel dan sel-selnya */
                                table {
                            ...
                            <tr>
                                ...
                                <th rowspan="2" class="file-column">File</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->register }}</td>
                                <td>{{ $data->tingkat_bangunan }}</td>
                                <td>{{ $data->beton_bangunan }}</td>
                                <td>{{ $data->luas_lantai }}</td>
                                <td>{{ $data->alamat }}</td>
                                <td>{{ $data->tanggal }}</td>
                                <td>{{ $data->nomor }}</td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a id="confirmDelete" href="{{ route('bangunan.delete', ['id' => $data->id]) }}" class="btn btn-danger delete-btn" data-id="{{ $data->id }}">Hapus</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <script>
                                        $(document).ready(function() {
                                            ...
                                            $('.delete-btn').on('click', function(e) {
                                                ...
                                                $('#confirmDelete').attr('href', '/bangunan/' + id + '/delete');
                                                $('#deleteModal-' + id).modal('show');
                                            });
                                        });
                                    </script>
                                    <a class="btn btn-info" href="{{ route('bangunan.edit', ['id' => $data->id]) }}" style="margin-bottom: 5px;"><i class="fa fa-edit"></i> </a>
                                    <a href="{{ route('bangunan.download', ['id' => $data->id]) }}" class="btn btn-success" onclick="checkFileAvailability('{{ $data->file_pdf }}')"><i class="fa fa-download"></i> </a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                        ...
                        <script>
                            function exportToPDF() {
                                ...
                                pdf.autoTable({
                                    html: '#myTable',
                                    columnStyles: {
                                        16: { // Sesuaikan dengan indeks kolom "File"
                                            visible: false
                                        },
                                        17: { // Sesuaikan dengan indeks kolom "Action"
                                            visible: false
                                        }
                                    },
                                    margin: {
                                ...
                                pdf.setPage(1);
                                pdf.text("Data Asset Gedung dan Bangunan", pdf.internal.pageSize.width / 2, 15, 'center');
                                pdf.text("Dinas Pertanian Perikanan dan Pangan", pdf.internal.pageSize.width / 2, 25, 'center');

                                pdf.save('asset_bangunan.pdf');
                            }
                        </script>
                        ...
                        <script>
                            function exportToExcel() {
                                ...
                                var title = [
                                    ['Data Asset Gedung dan Bangunan'],
                                ...
                                XLSX.writeFile(wb, 'asset_bangunan.xlsx');
                            }
                        </script>
                        ...
                        <script>
                            function printTable() {
                                ...
                                var hiddenColumns = [16, 17]; // Sesuaikan dengan indeks kolom "File" dan "Action"
                                ...
                                var printContents = "<div class='print-title'><h1>Data Asset Gedung dan Bangunan</h1><h1>Dinas Pertanian Perikanan dan Pangan</h1></div>";
